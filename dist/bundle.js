...
var Taxonomy = _backbone.Model.extend({
...
var _taxonomy = __webpack_require__(3);

var _taxonomy2 = _interopRequireDefault(_taxonomy);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var TaxonomyView = _backbone.View.extend({
  ...
  render: function render() {
    if ((0, _jquery2.default)(".reproductie").hasClass("handselected") === false && (0, _jquery2.default)(".toepassing").hasClass("handselected") === false && (0, _jquery2.default)(".inzicht").hasClass("handselected") === false) {

      switch (this.options.taxonomy) {
        case "1":
          (0, _jquery2.default)(".reproductie").addClass("selected");
          (0, _jquery2.default)(".toepassing").removeClass("selected");
          (0, _jquery2.default)(".inzicht").removeClass("selected");
          break;
        case "2":
          (0, _jquery2.default)(".toepassing").addClass("selected");
          (0, _jquery2.default)(".reproductie").removeClass("selected");
          (0, _jquery2.default)(".inzicht").removeClass("selected");
          break;
        case "3":
          (0, _jquery2.default)(".inzicht").addClass("selected");
          (0, _jquery2.default)(".reproductie").removeClass("selected");
          (0, _jquery2.default)(".toepassing").removeClass("selected");
          break;
        default:
          (0, _jquery2.default)(".tips").html("");
          break;
      }
    }
  }
...
var Question = _backbone.Model.extend({
  initialize: function initialize(props) {
    this.url = props.url;
  }
});
...
var Spelling = _backbone.Model.extend({
  initialize: function initialize(props) {
    this.url = props.url;
  }
});
...
var CommentView = _backbone.View.extend({
  el: 'body',
  initialize: function initialize(options) {
    this.options = options;
    this.render();
  ...
  hidemodal: function hidemodal() {
    ...
    (0, _jquery2.default)("#modalshare").remove();
  },
...
var QuestionfeedbackView = _backbone.View.extend({
  el: 'body',
  template: _underscore2.default.template((0, _jquery2.default)('#feedbackTemplate').html()),
  events: {
    'click .opslaan': 'save'
  },
  initialize: function initialize(options) {
  ...
  save: function save() {
    ...
    (0, _jquery2.default)('.opslaan').attr("disabled", "disabled");
...
var _taxonomyview = __webpack_require__(4);
...
var _spelling = __webpack_require__(6);

var _spelling2 = _interopRequireDefault(_spelling);
...
var TextAreaView = _backbone.View.extend({
  el: 'body',
  events: {
    'keyup #values': 'keyup',
  ...
  save: function save() {
    _jquery2.default.ajax({
      ...
      "data": {
        ...
        "answer": (0, _jquery2.default)('.antwoord').text()
      }
...
var Comment = _backbone.Model.extend({
  initialize: function initialize(props) {
    this.url = props.url;
  }
});
...
var KeywordView = _backbone.View.extend({
  ...
  render: function render() {
    ...
    (0, _jquery2.default)(".keywords").html("");
    for (var keyword in keywords) {
      (0, _jquery2.default)(".keywords").append("<a class='keyword' target='_blank' href='http://www.google.com/search?q=" + keywords[keyword] + "'>" + keywords[keyword] + " </a>");
    }
  }
});
...
var SpellingView = _backbone.View.extend({
  initialize: function initialize(options) {
    this.options = options;
    this.render();
  },
  render: function render() {
    ...
    if ((0, _jquery2.default)(word)) {

      // Create suggestions list
      var suggestionsWrapper = (0, _jquery2.default)("<ul class='suggestions-wrapper'></ul>");
      suggesties.forEach(function (suggestion) {
        var suggestionListItem = (0, _jquery2.default)("<li>" + suggestion + "</li>").on('click', onSuggestionClick);
        suggestionsWrapper.append(suggestionListItem);
      });

      // Append suggestion list to word span
      var wordElement = (0, _jquery2.default)(word);
    ...
    function onSuggestionClick(e) {
      ...
      word.split('.').forEach(function (singleClass) {
